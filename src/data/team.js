export const team = [
  ...
  {
    id: 'shama',
    name: 'Dr. Shama Zakir Khan',
    role: 'Chief Operating Officer (COO)',
    specialty: 'Education Operations & Quality Assurance',
    avatar: 'SZ',
    image: '/assets/team/SZ.jpeg',
    ...
    credentials: [
      ...
      'Expert in Quality Assurance and Accreditation',
      'International Education Policy Specialist',
      'Student Success & Retention Strategist',
    ],
    stats: [
      { label: 'Years in Education', value: '12+' },
      { label: 'Institutions Led', value: '5+' },
      { label: 'Students Mentored', value: '3000+' },
    ],
    social: {
      linkedin: '#',
      twitter: '#',
...
export const contactInfo = {
  ...
  social: {
    ...
    twitter: '#',
    instagram: 'https://www.instagram.com/profrontier_onlineacademy?igsh=emF0bXlsb2cxNzY0',
    linkedin: '#',
    pinterest: '#',
  },
};
